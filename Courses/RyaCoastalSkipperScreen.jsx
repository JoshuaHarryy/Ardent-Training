            ...
            <View style={styles.container}>
                    ...
                    <View style={{ width: '90%' }}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={styles.button}>
                                <Text style={styles.buttonText}>Buy Now  (£345)</Text>
                            </TouchableOpacity>
                        </View>
              ...
              Can I gift an RYA online course to someone else?
                ...
                <View style={{ alignItems: 'center', marginTop: 60, marginBottom: 40 }}>
                    <Text style={{ marginHorizontal: 20, fontSize: 20, fontWeight: '500', color: '#003366', color: 'black' }}>Why Learn With Us?</Text>
                </View>
