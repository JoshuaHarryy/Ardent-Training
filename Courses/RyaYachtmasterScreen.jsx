    ...
    return (
        <ScrollView>
            <View style={{flex: 1, backgroundColor: 'white'}}>
                ...
                <Image
                    source={require('../Assets/yachtmaster-coming-soon.webp')}
                    style={{ height: 260, width: '100%' }}
                />
                <View style={{ marginHorizontal: 10, marginTop: 20 }}>
                    <Text style={{ fontSize: 19, fontWeight: '500', color: '#003366' }}>RYA Yacthmaster Ocean Theory Course</Text>
                </View>

                <View style={{ marginHorizontal: 10, marginTop: 10 }}>
                    <Text style={{ fontSize: 15, fontWeight: '500', color: '#003366' }}>Online Course</Text>
                </View>
                ...
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ width: '90%' }}>
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontWeight: '700', fontSize: 19, color: '#003366', marginBottom: 5 }}>Pre-course Experience Required</Text>
                            <Text style={{ fontWeight: '600', fontSize: 14, color: 'black'}}>24.5</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontWeight: '600', fontSize: 14, alignSelf: 'center', color: 'black' }}> Minimum 40 hours</Text>
                        ...
                        .map(item => (
                            <View key={item.id}>
                                ...
                                <View style={{ position: 'absolute', top: '20%', width: '100%', alignItems: 'center' }}>
                                    ...
                                    >
                                        <Text style={{ color: '#fff', fontWeight: '500', fontSize: 18 }}>Buy Now  (£315)</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        ))}
