...
export default function RyaSkipperPlayerScreen({ route, navigation }) {
  ...
  const completedLessons = courseData?.chapters?.reduce((sum, chapter) => {
    return (
      sum +
      (chapter.lessons?.filter((lesson) => lesson.isCompleted).length || 0)
    );
  }, 0);


  const progress1 = totalLessons > 0 ? completedLessons / totalLessons : 0;
  ...
  const fetchCourses = async () => {
    try {
      ...
      const response = await fetch(`https://staging.ardent-training.com/api/course/${courseId}`, {
        method: 'GET',
        headers: {
      ...
      // console.log('full course', JSON.stringify(data.data))
      ...
      if (chapters?.length > 0) {
        ...
        while (chapterIndex < chapters.length && chapterIndex < 16) { // Limit to chapter 16
          const lessons = chapters[chapterIndex]?.lessons;
          if (lessons?.length > 0) {
            const currentLesson = lessons[lessonIndex];

            if (currentLesson?.isCompleted === false) {
              setVideoUrl(currentLesson?.courseLink);
              break;
            } else {
              lessonIndex++;
  ...
  const saveVideoUrl = async (url) => {
    try {
      await AsyncStorage.setItem('savedVideoUrl', url);
      console.log('Video URL saved successfully!', url);
    } catch (error) {
      console.error('Failed to save the video URL:', error);
    }
  };
      ...
      <View>
          ...
          <View style={{ height: 55, width: '100%', backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
            <View style={{ justifyContent: 'center', alignItems: 'center', height: 40, width: '25%', backgroundColor: '#173A70', borderRadius: 7, marginHorizontal: 2 }}>
              <TouchableOpacity
                onPress={async () => {
                  if (selectedLesson) {
                    await markLessonInCompleted(selectedLesson.lessonId);
                    fetchCourses();
                  } else {
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', height: 40, width: '25%', backgroundColor: '#173A70', borderRadius: 7, marginHorizontal: 2 }}>
              <TouchableOpacity
                onPress={async () => {
                  if (selectedLesson) {
                    await markLessonAsCompleted(selectedLesson.lessonId);
                    fetchCourses();
                  } else {
                    alert("Please select a lesson first.");
                  }
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', height: 40, width: '20%', backgroundColor: '#173A70', borderRadius: 7, marginHorizontal: 2 }}>
              <TouchableOpacity
                onPress={() => navigation.navigate('Discussion', { lessonId: selectedLesson.lessonId }, console.log(selectedLesson.lessonId))}
              >
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('Home') }}>
          <View style={{ flexDirection: 'row', marginTop: 10, marginHorizontal: 30 }}>
            <MaterialIcons name={"arrow-back-ios"} size={20} color={"black"} style={styles.ArrowIcon} />
            <Text style={{ color: 'black', fontSize: 14, marginTop: 1 }}>Back to Classroom</Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={{ flexDirection: 'row' }}>
          <Image style={{ height: 50, width: 80, marginTop: 20, marginHorizontal: 20 }}
            source={
          ...
          {courseData?.chapters && courseData.chapters[0] && (
            <View>
              ...
              {selectedChapterIndex === 0 && courseData?.chapters?.[0].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    const selectedVideoUrl = courseData.chapters?.[0].lessons?.[0].courseLink;
                    setVideoUrl(selectedVideoUrl);
                    setSelectedLesson({
                      lessonId: courseData.chapters[0].lessons[0].id,
                      chapterIndex: 0,
                      lessonIndex: 0,
                    });
                    saveVideoUrl(selectedVideoUrl);
                  }}
                >
              ...
              {selectedChapterIndex === 0 && courseData.chapters[0].lessons?.[2] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[0].lessons[2].id, chapterIndex: 0, lessonIndex: 2 }); // Update indices
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 20 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 0 && courseData.chapters[0].lessons?.[3] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[0].lessons[3].id, chapterIndex: 0, lessonIndex: 3 }); // Update indices
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 20 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 0 && courseData.chapters[0].lessons?.[4] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[0].lessons[4].id, chapterIndex: 0, lessonIndex: 4 }); // Update indices
                  }}
                >
        ...
        <View style={{ marginHorizontal: 20, marginTop: 10 }}>
          {courseData?.chapters && courseData.chapters[1] && (
            <View>
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[0].id, chapterIndex: 1, lessonIndex: 0 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[1] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[1].id, chapterIndex: 1, lessonIndex: 1 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[2] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[2].id, chapterIndex: 1, lessonIndex: 2 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[3] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[3].id, chapterIndex: 1, lessonIndex: 3 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[4] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[4].id, chapterIndex: 1, lessonIndex: 4 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[5] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[5].id, chapterIndex: 1, lessonIndex: 5 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[6] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[6].id, chapterIndex: 1, lessonIndex: 6 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[7] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[7].id, chapterIndex: 1, lessonIndex: 6 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[8] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[8].id, chapterIndex: 1, lessonIndex: 7 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[9] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[9].id, chapterIndex: 1, lessonIndex: 7 });
                  }}
                >
              ...
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[10] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[10].id, chapterIndex: 1, lessonIndex: 7 }); // Update indices
                  }}
                >
              ...
              {/* Lesson 12 */}
              {selectedChapterIndex === 1 && courseData.chapters[1].lessons?.[11] && (
                <TouchableOpacity
                  onPress={() => {
                    setVideoUrl(courseData.chapters[1].lessons[11].courseLink);
                    setSelectedLesson({ lessonId: courseData.chapters[1].lessons[11].id, chapterIndex: 1, lessonIndex: 7 }); // Update indices
                  }}
                >

                  <View style={{ marginLeft: 20, marginTop: 20 }}>
                    {/* Display only the first lesson */}
                    <View key={courseData.chapters[1].lessons[11].id} style={{ marginTop: 10, flexDirection: 'row' }}>
                      {/* Custom Circular Checkbox */}
                      {customTick(1, 11)}
                      <Text style={{ color: 'black', fontSize: 15, marginHorizontal: 10, marginTop: 9 }}>
                        {courseData.chapters[1].lessons[11].name}
                      </Text>
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[0].id, chapterIndex: 2, lessonIndex: 0 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[1] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[1].id, chapterIndex: 2, lessonIndex: 1 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[2] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[2].id, chapterIndex: 1, lessonIndex: 2 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[3] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[3].id, chapterIndex: 1, lessonIndex: 3 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[4] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[4].id, chapterIndex: 1, lessonIndex: 4 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[5] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[5].id, chapterIndex: 1, lessonIndex: 5 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[6] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[6].id, chapterIndex: 1, lessonIndex: 6 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[7] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[7].id, chapterIndex: 1, lessonIndex: 7 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[8] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[8].id, chapterIndex: 1, lessonIndex: 8 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[9] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[9].id, chapterIndex: 1, lessonIndex: 9 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[10] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[10].id, chapterIndex: 1, lessonIndex: 10 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[11] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[11].id, chapterIndex: 1, lessonIndex: 11 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[12] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[12].id, chapterIndex: 1, lessonIndex: 12 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[13] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[13].id, chapterIndex: 1, lessonIndex: 13 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[14] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[14].id, chapterIndex: 1, lessonIndex: 14 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[15] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[15].id, chapterIndex: 1, lessonIndex: 15 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.[16] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[2].lessons[16].id, chapterIndex: 1, lessonIndex: 16 }); // Update indices
                  }}
                >
              ...
              {selectedChapterIndex === 2 && courseData.chapters[2].lessons?.
lessons?.[9] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[12].lessons[9].id, chapterIndex: 12, lessonIndex: 9 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
            ...
            <View>
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[0].id, chapterIndex: 13, lessonIndex: 0 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[1] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[1].id, chapterIndex: 13, lessonIndex: 1 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[2] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[2].id, chapterIndex: 13, lessonIndex: 2 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[3] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[3].id, chapterIndex: 13, lessonIndex: 3 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[4] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[4].id, chapterIndex: 13, lessonIndex: 4 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[5] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[5].id, chapterIndex: 13, lessonIndex: 5 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[6] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[6].id, chapterIndex: 13, lessonIndex: 6 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[7] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[7].id, chapterIndex: 13, lessonIndex: 7 });
                  }} s
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[8] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[8].id, chapterIndex: 13, lessonIndex: 8 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[9] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[9].id, chapterIndex: 13, lessonIndex: 9 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[11] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[11].id, chapterIndex: 13, lessonIndex: 11 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[12] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[12].id, chapterIndex: 13, lessonIndex: 12 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 11 && courseData.chapters[11].lessons?.[13] && (
                <TouchableOpacity
                  onPress={() => {
                    setVideoUrl(courseData.chapters[11].lessons[13].courseLink);
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[13].id, chapterIndex: 11, lessonIndex: 13 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
            ...
            <View>
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[0].id, chapterIndex: 14, lessonIndex: 0 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[1] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[1].id, chapterIndex: 14, lessonIndex: 1 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[2] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[2].id, chapterIndex: 14, lessonIndex: 2 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[3] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[3].id, chapterIndex: 14, lessonIndex: 3 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[4] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[4].id, chapterIndex: 14, lessonIndex: 4 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[5] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[5].id, chapterIndex: 14, lessonIndex: 5 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[6] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[6].id, chapterIndex: 14, lessonIndex: 6 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[7] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[7].id, chapterIndex: 14, lessonIndex: 7 });
                  }} s
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 14 && courseData.chapters[14].lessons?.[8] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[14].lessons[8].id, chapterIndex: 14, lessonIndex: 8 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 13 && courseData.chapters[13].lessons?.[11] && (
                <TouchableOpacity
                  onPress={() => {
                    setVideoUrl(courseData.chapters[13].lessons[11].courseLink);
                    setSelectedLesson({ lessonId: courseData.chapters[15].lessons[11].id, chapterIndex: 13, lessonIndex: 11 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {/* lesson 14*/}
              {selectedChapterIndex === 11 && courseData.chapters[13].lessons?.[13] && (
                <TouchableOpacity
                  onPress={() => {
                    setVideoUrl(courseData.chapters[13].lessons[13].courseLink);
                    setSelectedLesson({ lessonId: courseData.chapters[13].lessons[13].id, chapterIndex: 11, lessonIndex: 13 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
                    <View key={courseData.chapters[13].lessons[13].id} style={{ marginTop: 10, flexDirection: 'row' }}>
                      {/* Custom Circular Checkbox */}
                      {customTick(13, 13)}
                      <Text style={{ color: 'black', fontSize: 15, marginHorizontal: 10, marginTop: 9 }}>
                        {courseData.chapters[13].lessons[13].name}
                      </Text>
              ...
              {selectedChapterIndex === 15 && courseData.chapters[15].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[15].lessons[0].id, chapterIndex: 15, lessonIndex: 0 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 15 && courseData.chapters[15].lessons?.[1] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[15].lessons[1].id, chapterIndex: 15, lessonIndex: 1 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
              ...
              {selectedChapterIndex === 16 && courseData.chapters[16].lessons?.[0] && (
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setSelectedLesson({ lessonId: courseData.chapters[16].lessons[0].id, chapterIndex: 16, lessonIndex: 0 });
                  }}
                >
                  <View style={{ marginLeft: 20, marginTop: 10 }}>
                    {/* Display only the first lesson */}
