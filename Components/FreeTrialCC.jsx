...
export default function FreeTrialCC({ courses }) {
        ...
        <View>
            <View style={styles.card}>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity onPress={()=> navigation.navigate("RyaDaySkipperCoursePlayer", { courseId: courses.id }, console.log("CourseId", courses.id))}>
                        <View style={styles.buyNowButton}>
                            <Text style={styles.buyNowText}>TRY IT FOR FREE</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
